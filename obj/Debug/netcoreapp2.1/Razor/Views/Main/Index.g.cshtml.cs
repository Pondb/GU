#pragma checksum "C:\Users\Pond\source\repos\All_Project\GU\GU\Views\Main\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "30a74d3ea4a23894d9c4e2c6619ec95be5c3aba7"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"30a74d3ea4a23894d9c4e2c6619ec95be5c3aba7", @"/Views/Main/Index.cshtml")]
...
#line hidden
    ...
    function create() {
        ...
        //treeBlock.create(userWidth * 0.5, userHei");
            WriteLiteral(@"ght * 0.5, 'trees').setScale(1).refreshBody();

        treeBlock = this.physics.add.staticGroup();

        treeBlock.create(900, 300, 'plain_field').setScale(1).refreshBody();
        treeBlock.create(900, 300, 'trees').setScale(1).refreshBody();
        ...
        if (bgDayorNight == ""Day"") {
            ...
            //If task != 0
            if (taskToday != 0) {
                havetoFinish_text = this.add.text(userWidth * 0.045, userWidth * 0.075, taskToday + "" tasks should be completed within today."", { fontSize: '18px', fill: '#415869' });
            }
            else {
                havetoFinish_text = this.add.text(userWidth * 0.045, userWidth * 0.075, ""You don't have any task today."", { fontSize: '18px', f");
            WriteLiteral(@"ill: '#415869' });
            }


            //TREE LEVEL
            coin_text = this.add.text(userWidth * 0.07, userWidth * 0.045, 'LV ' + treeLevel, { fontSize: '24px', fill: 'gray' });

            //Task/Complete_Task
            task_text = this.add.text(userWidth * 0.12, userWidth * 0.045, ""HP:"" + tree_hp + '/100', { fontSize: '24px', fill: 'gray' });

            //TREE HP
            hp_text = this.add.text(userWidth * 0.27, userWidth * 0.045, task_complete + '/' + task_count, { fontSize: '24px', fill: 'gray' });
            ...
            if (taskToday != 0) {
                ...
                havetoFinish_text = this.add.text(userWidth * 0.045, userWidth * 0.075,  ""You don't have any task");
            WriteLiteral(@" today."", { fontSize: '18px', fill: '#ffe790' });
            }
...
");
            ...
            WriteLiteral("\r\n\r\n\r\n");
            EndContext();
#line 235 "C:\Users\Pond\source\repos\All_Project\GU\GU\Views\Main\Index.cshtml"
...
#line default
#line hidden
            BeginContext(7037, 106, true);
            WriteLiteral("        <div class=\"row\">\r\n            <div id=\"phaser-container\">\r\n\r\n            </div>\r\n        </div>\r\n");
            EndContext();
#line 254 "C:\Users\Pond\source\repos\All_Project\GU\GU\Views\Main\Index.cshtml"
...
#line hidden
            ...
            EndContext();
#line 263 "C:\Users\Pond\source\repos\All_Project\GU\GU\Views\Main\Index.cshtml"

    }

#line default
#line hidden
            BeginContext(7336, 28, true);
            WriteLiteral("\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n");
            EndContext();
            BeginContext(7365, 25, false);
#line 280 "C:\Users\Pond\source\repos\All_Project\GU\GU\Views\Main\Index.cshtml"
