#pragma checksum "C:\Users\Pond\source\repos\All_Project\GU\GU\Views\Main\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4e65d4ebe9adb267e5fd1144445a4a38a8fcd1fa"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4e65d4ebe9adb267e5fd1144445a4a38a8fcd1fa", @"/Views/Main/Index.cshtml")]
...
#line hidden
    ...
    function create() {
        ...
        if (G2_isHere) {
            ...
            treeBlock_03.create(990, 335, 'g2_tree').setScale(1).refreshBody();
        }
        ...
        if (G3_isHere) {
            ...
            WriteLiteral(@";
            treeBlock_04.create(1275, 505, 'g3_tree').setScale(1).refreshBody();
        }
        ...
        treeBlock_01.create(700, 500, 'trees').setScale(1).refreshBody();
        ...
        if (G1_isHere) {
            ...
            treeBlock_02.create(985, 730, 'plain_field').se");
            WriteLiteral(@"tScale(1).refreshBody();
            treeBlock_02.create(985, 670, 'g1_tree').setScale(1).refreshBody();
        }
        ...
        if (bgDayorNight == ""Day"") {
            ...
            //TREE LEVEL
            level_text = this.add.text(130, 65, 'LV ' + tree");
            WriteLiteral(@"Level, { fontSize: '48px', fill: 'gray' });
            ...
            if (taskToday == 1) {
                ...
                havetoF");
            WriteLiteral(@"inish_text = this.add.text(130,160, ""You don't have any task today."", { fontSize: '36px', fill: '#ffe790' });
            }
